...
#ifndef FLUTTER2_SWIFT_H
#define FLUTTER2_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="flutter2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8flutter211AppDelegate")
...
SWIFT_CLASS("_TtC8flutter217MainFlutterWindow")
